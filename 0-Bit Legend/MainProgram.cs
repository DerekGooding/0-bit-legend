...
public class MainProgram
{
    ...
    public static void UpdateHud()
    {
        ...
        if (health > 2.5)
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       <3  <3  <3        X#{_hud.AsSpan(224)}";
        }
        else if (health > 2)
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       <3  <3  =         X#{_hud.AsSpan(224)}";
        }
        else if (health > 1.5)
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       <3  <3            X#{_hud.AsSpan(224)}";
        ...
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       <3  =             X#{_hud.AsSpan(224)}";
        }
        else if (health > 0.5)
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       <3                X#{_hud.AsSpan(224)}";
        ...
        {
            _hud = $"{_hud.AsSpan(0, 196)}X       =                 X#{_hud.AsSpan(224)}";
        }
        else
        {
            _hud = $"{_hud.AsSpan(0, 196)}X                         X#{_hud.AsSpan(224)}";
