...
public class MainMap1 : BaseMap
 {
    public override string Name => "MainMap1";
     ...
     [
        new(MapId: WorldMap.MapName.MainMap5, StartPosition: new(52, 18), DirectionType.Left, Size: new(3, 10), Position: new(0, 9)),
        new(MapId: WorldMap.MapName.MainMap0, StartPosition: new(52, 18), DirectionType.Up, Size: new(26, 2), Position: new(52, 31)),
        new(MapId: WorldMap.MapName.MainMap4, StartPosition: new(52, 18), DirectionType.Right, Size: new(3, 13), Position: new(98, 12)),
     ];
 }
